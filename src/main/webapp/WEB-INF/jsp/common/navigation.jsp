...
<!--  -->
                        ...
                        <li>
                            <a href=viewAddWare><i class="fa fa-files-o fa-fw"></i> 물류센터 등록</a>
                        </li>
                        <li>
                            <a href="wareList"><i class="fa fa-files-o fa-fw"></i> 물류센터 조회</a>
                        </li>                        
                        <li>
                            <a href="boardList"><i class="fa fa-files-o fa-fw"></i> <s:message code="board.boardName"/></a>
                        </li>                        
                        <li>
                            <a href="test"><i class="fa fa-files-o fa-fw"></i>test</a>
                        </li>                        
