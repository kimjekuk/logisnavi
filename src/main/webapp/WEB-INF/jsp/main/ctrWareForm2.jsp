  	...
  	<div class="row">
        <div class="col-md-6">
			<table  id="tables" class="table table-bordered  table-sm" style="cellspacing:0;width:100%;text-align:center;" >
				...
				<td><input type="text" class="form-control form-control-sm" id="cofine" name="cofine" size="20" value="${wahama.cofine}"  required ></td>
				</tr>				
				<tr>
					<td style="background: #FAFAFA;">운영사</td>
					<td><input type="text" class="form-control form-control-sm" id="cooper" name="cooper" size="20" value="${wahama.cooper}"  required ></td>
				</tr>				
				<tr>
