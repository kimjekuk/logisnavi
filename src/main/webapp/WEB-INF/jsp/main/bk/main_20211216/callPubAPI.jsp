		...
		window.onload = function(){
			...
			gridtf = new tui.Grid({
		        ...
		        columns: [
		          { header: '번호', name: 'seq' },
		          { header: '건물명', name: 'bldNm' },
		          { header: '동명칭', name: 'dongNm' },
		          { header: '층구분코드명', name: 'flrGbCdNm' },
		          { header: '층번호명', name: 'flrNoNm' },
		          { header: '주용도코드명', name: 'mainPurpsCdNm' },
		          { header: '면적', name: 'area' },
		          { header: '기타용도', name: 'etcPurps' },
		          { header: '생성일', name: 'crtnDay' }			          
		        ]
		    });	    
			...
			gridbf = new tui.Grid({
		        ...
		        columns: [
		          ...
		          { header: '건물명', name: 'bldNm' },
		          { header: '층구분코드명', name: 'flrGbCdNm' },
		          { header: '층번호', name: 'flrNo' },
		          { header: '층면적(㎡)', name: 'flrArea' },
		          { header: '주용도코드명', name: 'mainPurpsCdNm' },
		          { header: '관리허가대장PK', name: 'mgmPmsrgstPk' },
		          { header: '생성일', name: 'crtnDay' }			          
		        ]
			...
			if ( ! chkInputValue("#searchExt3", "번")) return false;
			 ...
			 //표제부 
	      	$.ajax({
	      		url: "jsontest",
	      		type:"post", 
	      		data : {"sigunguCd":$("#searchExt1").val(), "bjdongCd":$("#searchExt2").val(), "bun":$("#searchExt3").val(), "ji":$("#searchExt4").val(), "gubun" : "gridt" },
	      	...
	      	$.ajax({
	      		url: "jsontest",
	      		type:"post", 
	      		data : {"sigunguCd":$("#searchExt1").val(), "bjdongCd":$("#searchExt2").val(), "bun":$("#searchExt3").val(), "ji":$("#searchExt4").val(), "gubun" : "gridtf" },
	      		success : function(result){  
	      			json = JSON.parse(result);
			 ...
			 //인허가 
	      	$.ajax({
	      		url: "jsontest",
	      		type:"post", 
	      		data : {"sigunguCd":$("#searchExt1").val(), "bjdongCd":$("#searchExt2").val(), "bun":$("#searchExt3").val(), "ji":$("#searchExt4").val(), "gubun" : "gridb" },
	      		success : function(result){  
	      			json = JSON.parse(result);
			 ...
			 //인허가 (층별)
	      	$.ajax({
	      		url: "jsontest",
	      		type:"post", 
	      		data : {"sigunguCd":$("#searchExt1").val(), "bjdongCd":$("#searchExt2").val(), "bun":$("#searchExt3").val(), "ji":$("#searchExt4").val(), "gubun" : "gridbf" },
	      		success : function(result){  
	      			json = JSON.parse(result);
