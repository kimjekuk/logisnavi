           	...
           	<form id="form1" name="form1" role="form" action="saveNewWare" method="post" onsubmit="return fn_formSubmit();" >
				...
				<div id="map" style="width:1100px;height:500px;margin-top:10px;display:none"></div>
                   ...
                   <br><br>
  			        ...
  			        test
                      	<input type="text" readonly id="sigunguCode" name="sigunguCode" maxlength="10" value="<c:out value="${wareInfo.sigunguCode}"/>">
                      	<input type="text" readonly id="bcode" name="bcode" maxlength="10" value="<c:out value="${wareInfo.bcode}"/>">
