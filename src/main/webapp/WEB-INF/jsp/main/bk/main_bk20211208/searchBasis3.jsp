...
//			alert('modal!');
			...
			$.ajax({
				...
				success : function(result){         
					$('#modalGridData').text(searchVO.searchExt8);
					set_pop();
				},
		        error: function() {
        ...
        function set_pop() {
//        	alert('111');
//        	alert($("#modalGridData").val());
			jsonf = JSON.parse($("#modalGridData").val());
        	alert(jsonf);
...
<body>
    ...
    <div class="container py-5"  style="border:1px red;">
            ...
            <form class="col-md-9 m-auto" role="form" id="form1" name="form1"  method="post">
               ...
               <label for="inputSearch3">검색어(명칭 및 위치)</label> 
    ...
    <!-- 옵션 : 실제착공일 ~이상 -->
		실제착공일 
			...
			<br>         
              	<input type="checkbox" name="searchType" value="" <c:if test="${fn:indexOf(searchVO.searchType, 'realStcnsDay')!=-1}">checked="checked"</c:if>/>
				사용승인일 유무
			<br>
