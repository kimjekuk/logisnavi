						...
						<div class="row">
							...
							<div class="col-md-2 ">
								...
								<select class="custom-select" id="lmtemp" name="lmtemp" style="font-size:13px;min-width:20px;" required>
								  ...
								  <option value="상온" <c:if test="${reqlmInfo.lmtemp eq '상온'}">selected</c:if>>상온</option>
								  <option value="냉장" <c:if test="${reqlmInfo.lmtemp eq '냉장'}">selected</c:if>>냉장</option>
								  <option value="냉동" <c:if test="${reqlmInfo.lmtemp eq '냉동'}">selected</c:if>>냉동</option>
								</select>
								<select class="custom-select" id="lmtemp2" name="lmtemp2" style="font-size:13px;min-width:20px;" >
								  ...
								  <option value="상온" <c:if test="${reqlmInfo.lmtemp2 eq '상온'}">selected</c:if>>상온</option>
								  <option value="냉장" <c:if test="${reqlmInfo.lmtemp2 eq '냉장'}">selected</c:if>>냉장</option>
								  <option value="냉동" <c:if test="${reqlmInfo.lmtemp2 eq '냉동'}">selected</c:if>>냉동</option>
								</select>
								<select class="custom-select" id="lmtemp3" name="lmtemp3" style="font-size:13px;min-width:20px;" >
								  ...
								  <option value="상온" <c:if test="${reqlmInfo.lmtemp3 eq '상온'}">selected</c:if>>상온</option>
								  <option value="냉장" <c:if test="${reqlmInfo.lmtemp3 eq '냉장'}">selected</c:if>>냉장</option>
								  <option value="냉동" <c:if test="${reqlmInfo.lmtemp3 eq '냉동'}">selected</c:if>>냉동</option>
								</select>
<!--  
						            ...
						            <div class="custom-control custom-checkbox">
						              <input type="checkbox" class="custom-control-inline"  value="냉동" name="lmtemp2" >
									  <label>냉동</label> 
						            </div>
						            <div class="custom-control custom-checkbox">
						              <input type="checkbox" class="custom-control-inline"  value="냉장" name="lmtemp3" >
									  <label>냉장</label> 
						            </div>
-->						            
							</div>
...
-->								
			...
			<table  id="tables" class="table table-bordered  table-sm" style="cellspacing:0;width:100%;text-align:center;" >
				<tr style="background-color:#FAFAFA; font-size:13px;text-align:left;">
					<td style="padding-left:15px">비고</td>
				</tr>
				<tr>
					<td>
						<div class="row">
